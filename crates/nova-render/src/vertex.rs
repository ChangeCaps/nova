...
impl_as_vertex_format!(Vec2 => VertexFormat::Float32x2);
impl_as_vertex_format!(IVec2 => VertexFormat::Sint32x2);
impl_as_vertex_format!(UVec2 => VertexFormat::Uint32x2);
impl_as_vertex_format!(Vec3 => VertexFormat::Float32x3);
impl_as_vertex_format!(IVec3 => VertexFormat::Sint32x3);
impl_as_vertex_format!(UVec3 => VertexFormat::Uint32x3);
impl_as_vertex_format!(Vec4 => VertexFormat::Float32x4);
impl_as_vertex_format!(Color => VertexFormat::Float32x4);
